...
<head>
    ...
    <title>Gallery - Japanese Ink Culture</title>
    <link rel="stylesheet" href="styles.css">
    <link href="https://fonts.googleapis.com/css2?family=Rock+Salt&display=swap" rel="stylesheet"> <!-- Adding font -->

    <!-- Meta Tags for SEO -->
    <meta name="description" content="Explore our gallery of traditional Japanese tattoos. See stunning examples of Irezumi, Horimono, and Tebori styles.">
    <meta name="keywords" content="Japanese tattoos gallery, Irezumi, Horimono, Tebori, Japanese tattoo designs, Japanese tattoo art, traditional Japanese tattoos, tattoo ideas">
    <meta name="author" content="Japanese Ink Culture">
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="Gallery - Japanese Ink Culture">
    <meta property="og:description" content="Explore our gallery of traditional Japanese tattoos. See stunning examples of Irezumi, Horimono, and Tebori styles.">
    <meta property="og:image" content="images/irezumi1.jpg">
    <meta property="og:url" content="http://www.japaneseinkculture.com/gallery.html">
    
    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Gallery - Japanese Ink Culture">
    <meta name="twitter:description" content="Explore our gallery of traditional Japanese tattoos. See stunning examples of Irezumi, Horimono, and Tebori styles.">
        ...
        <div id="gallery-container" class="gallery">
            <?php
                ...
                foreach($images as $image) {
                    echo '<img src="'.$image.'" alt="Tattoo Image" class="gallery-image">';
                }
            ?>
        </div>
    </main>
